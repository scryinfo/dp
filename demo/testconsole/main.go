...
func VerifierApproveTransfer(conn *ethclient.Client, verifier *contractclient.ContractClient)  {
    ...
    contractinterfacewrapper.ApproveTransfer(&txParam, common.HexToAddress(protocolContractAddr), big.NewInt(10000))
}
...
func CreditsToVerifier(conn *ethclient.Client, to common.Address) {
    ...
    contractinterfacewrapper.CreditsToVerifier(&txParam, txId, to, 5)
}
