        ...
        <el-row class="row">
            ...
            <el-col :span="16">
                ...
                <div class="right" id="show_new" v-if="showControl2">
                    <div>Your account is created : &nbsp;{{this.$store.state.account}}<br/>
...
export default {
    ...
    methods: {
        ...
        submit_login: function () {
            ...
            this.password = ""
            let _this = this
            astilectron.sendMessage({Name: "login.verify", Payload: {account: acc,
        ...
        submit_new: function () {
            ...
            astilectron.sendMessage({Name: "create.new.account", Payload: ""}, function (message) {
                _this.$store.state.account = message.payload
    ...
    created() {
        this.account = "";this.password = "";this.newAccount = "";this.describe = ""
        let _this = this
        dl_db.init(this)
        mt_db.init(this)
