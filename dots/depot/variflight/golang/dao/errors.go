...
// GetUrlError wraps error returned by http.Get() during calling Api
...
//  VariFlightDataQueryError represents error message responded by Api
...
// DecodeJsonError wraps error of decoding message from Api
