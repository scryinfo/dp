...
function generateGrpcNodeService(filename, descriptor, exportMap) {
    var definitionFilename = filename.replace(/_pb$/, "_grpc_pb.d.ts");
    return common_1.createFile(generateTypeScriptDefinition(descriptor, exportMap), definitionFilename);
}
