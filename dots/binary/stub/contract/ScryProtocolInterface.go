...
// ModifyVerifierNum is a paid mutator transaction binding the contract method 0xbe30b637.
//
// Solidity: function modifyVerifierNum(uint8 _value) returns()
func (_ScryProtocol *ScryProtocolTransactor) ModifyVerifierNum(opts *bind.TransactOpts, _value uint8) (*types.Transaction, error) {
	return _ScryProtocol.contract.Transact(opts, "modifyVerifierNum", _value)
}

// ModifyVerifierNum is a paid mutator transaction binding the contract method 0xbe30b637.
//
// Solidity: function modifyVerifierNum(uint8 _value) returns()
func (_ScryProtocol *ScryProtocolSession) ModifyVerifierNum(_value uint8) (*types.Transaction, error) {
	return _ScryProtocol.Contract.ModifyVerifierNum(&_ScryProtocol.TransactOpts, _value)
}

// ModifyVerifierNum is a paid mutator transaction binding the contract method 0xbe30b637.
//
// Solidity: function modifyVerifierNum(uint8 _value) returns()
func (_ScryProtocol *ScryProtocolTransactorSession) ModifyVerifierNum(_value uint8) (*types.Transaction, error) {
	return _ScryProtocol.Contract.ModifyVerifierNum(&_ScryProtocol.TransactOpts, _value)
}
