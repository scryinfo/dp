...
//		"D:/EnglishRoad/workspace/Go/src/github.com/scryInfo/dp/services/binary_s/log/scry_sdk.log",
...
//
//	_, err := PublishData(&main.PublishData{
//		IDs: main.IDs{
...
//	_, _ = CreateUserWithLogin("111")
//	_ = SubscribeEvents([]string{"DataPublish"}, onPublish)
//	publishID, _ := PublishData(&main.PublishData{
//		IDs: main.IDs{
//			MetaDataID: "QmRJCQ6uYcWppEoz7oogP9mivwvoCnEKFJn7j4fWCZ5aer",
//			ProofDataIDs: []string{"QmRhPUCtgFLzxbewyGB2Zzg25kxdowJHrFYodD6Q1AmMKy",
//				"QmZchYGj9xaoJuuXCdw7DYF7mLN8rDHe7kKQgpS1JAtDew"},
...
//}
//
//func onApprove(event events2.Event) bool {
//	approveTest = true
//	return true
//}
//
