...
<script lang="ts">
  ...
  export default class HelloWorld extends Vue {
    ...
    hide () {this.showControl1 = false; this.showControl2 = false; this.password = "";}
    ...
    submit_login() {
      ...
      this.password = "";
      connects.send({Name: "loginVerify", Payload: {address: acc, password: pwd}}, function (payload:any, _this:any) {
    ...
    submit_new(){
      ...
      this.password = "";
      let _login = this;
      connects.send({Name: "createNewAccount", Payload: {password: pwd}}, function (payload:any, _this:any) {
