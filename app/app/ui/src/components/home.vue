...
<script lang="ts">
  ...
  export class Home extends Vue{
    ...
    getBalance(){ this.$router.push("/blc"); }
    nickName () { this.$router.push("/ncn"); }
    message () { this.$router.push("/msg"); }
    logoutMsg () {
    ...
    created() {
      ...
      connects.send({Name:"currentUserDataUpdate", Payload: {}}, function (payload:any, _this:any) {
